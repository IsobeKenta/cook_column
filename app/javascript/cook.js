window.addEventListener('load', () =>{
  ...
  function appendChildrenBox(insertHTML) {
    let childSelectHtml = '';
    childSelectHtml =
      `<select class="cook_input__body__category__children--select" id="children_category">
  ...
  function appendGrandchildrenBox(insertHTML) {
    let grandchildSelentHtml = ''
    grandchildSelentHtml =
      `<select class="cook_input__body__category__grandchildren--select" id="grandchildren_category" name="cook[category_id]">
        <option value="" data-category="" >選択してください</option>
        ${insertHTML}</select>`;
